...
//    QYContactsTableViewCell *toMoveCell = [[QYContactsTableViewCell alloc] initWithStyle:UITableViewCellStyleSubtitle reuseIdentifier:@"cell"];
//    toMoveCell.friend = sourceGroup.friends[sourceIndexPath.row];
    ...
    //更改界面
//    NSArray *sourceIndexPaths = [NSArray arrayWithObjects:sourceIndexPath, nil];
//    NSArray *desIndexPaths = [NSArray arrayWithObjects:sourceIndexPath, nil];
    
//    [_tableView deleteRowsAtIndexPaths:sourceIndexPaths withRowAnimation:UITableViewRowAnimationFade];
//    [_tableView insertRowsAtIndexPaths:desIndexPaths withRowAnimation:UITableViewRowAnimationFade];
